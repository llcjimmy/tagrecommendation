...
for i=1:8
    tic;
    [Prior,PriorN,Cond,CondN]=MLKNN_train(train_data(:,1:(i*2000))',train_label(:,1:(i*2000)),Num,Smooth);
    MLKNN_time(i)=toc;
end
...
for i=1:8
    tic;
    [Prior,PriorN,Cond,CondN,KeyCondLabel]=MLKNN_train_small(train_data(:,1:(i*2000))',train_label(:,1:(i*2000)),Num,Smooth,WeakProTrain(1:(i*2000),:));
    MATAR_time(i)=toc;
end
