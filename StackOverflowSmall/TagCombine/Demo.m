...
disp('---------Result: ---------');
tic;
[MultilabelRankingScores] = MultilabelRanking(model, test_data);
[SimilarityRankingScores]=SimilarityRankingScore(train_data_tr,train_label_tr,test_data);
[TagTermRankingScores]=TagTermRankingScore(test_data,Aff);

%Outputs=alphe*MultilabelRankingScores+beta*SimilarityRankingScores+gamma*TagTermRankingScores;
Outputs=0.9*MultilabelRankingScores+0.1*SimilarityRankingScores+0.1*TagTermRankingScores;
%alphe=0.9 beta=0.1 gamma=0.1 will be better for us
toc;
