...
WeakPro=WeakPro(indexperm(1:15000),:);
...
for i=1:5
    tic;
    [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels]=MLKNN_test(train_data',train_label,test_data(:,1:(i*1000))',test_label(:,1:(i*1000)),Num,Prior,PriorN,Cond,CondN);
...
for i=1:5
    tic;
    [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels]=MLKNN_test_small(train_data',train_label,test_data(:,1:(i*1000))',test_label(:,1:(i*1000)),Num,Prior,PriorN,Cond,CondN,WeakProTest(1:(i*1000),:),KeyCondLabel);
    mRecall(Outputs,test_label(:,1:(i*1000)),5)
    mRecall(Outputs,test_label(:,1:(i*1000)),10)
    mRecall(Outputs,test_label(:,1:(i*1000)),20)
