function [Prior,PriorN,Cond,CondN,KeyCondLabel,KeyCondLabelN,NKeyCondLabel,NKeyCondLabelN]=MLKNN_train_fast(train_data,train_target,Num,Smooth,ProTrain)
...
%     end
    ...
    T1=lshSimple(6,size(train_data,2),train_data);
