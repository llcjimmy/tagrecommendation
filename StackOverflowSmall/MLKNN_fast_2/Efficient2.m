...
for i=1:5
    tic;
    [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels]=MLKNN_test_fast(train_data',train_label,test_data(:,1:(i*1000))',test_label(:,1:(i*1000)),Num,Prior,PriorN,Cond,CondN,WeakProTest(1:(i*1000),:),KeyCondLabel);
