...
disp('---------Training: ---------');
tic;
[Prior,PriorN,Cond,CondN,KeyCondLabel,T1]=MLKNN_train_fast(train_data',train_label,Num,Smooth,WeakProTrain);
toc;
%% STEP 2: Evaluation Large fast
disp('---------Result: ---------');
tic;
[HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels]=MLKNN_test_fast(train_data',train_label,test_data',test_label,Num,Prior,PriorN,Cond,CondN,WeakProTest,KeyCondLabel,T1);
toc;
