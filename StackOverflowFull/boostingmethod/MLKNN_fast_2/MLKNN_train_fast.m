function [Prior,PriorN,Cond,CondN,KeyCondLabel,KeyCondLabelN,T1]=MLKNN_train_fast(train_data,train_target,Num,Smooth,ProTrain)
...
%     end
    ...
    %feature�ĸ���feature*instance
    T1=lshSimple(10,size(train_data,2),train_data);
